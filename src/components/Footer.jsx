    ...
    return (
        ...
        <footer className="footer-container">
            <div className="footer-info">
                ...
                <p>Special thanks to  <b><i><a className='ank' href="https://www.youtube.com/@CodeWithHarry" target="_blank" rel="noopener noreferrer">@Code-with-Harry</a></i></b> and <b><i><a className='ank' href="https://chat.openai.com/chat" target="_blank" rel="noopener  noreferrer">Chat-gpt</a></i></b></p>
            ...
            <div className="social-icons">
                ...
                <a href="#"target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook"></i>our community</a>
                <a href="#"target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin"></i>contact us</a>
                <a href="#"target="_blank" rel="noopener noreferrer"><i className="fab fa-youtube"></i>Our channel</a>
